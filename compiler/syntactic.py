...
class Syntactic:
    ...
    def run(self):
        print(f"{colored.CYAN}TASK:{colored.NORMAL} Running syntactic analyzer on file: {self.file_path}")
        try:
            ...
            try:
                ...
                print(f"{colored.GREEN}RESULT:{colored.NORMAL} Finished running syntactic analyzer successfully on "
